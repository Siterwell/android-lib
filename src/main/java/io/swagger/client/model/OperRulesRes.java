...
import io.swagger.client.model.OperRulesResResults;
...
public class OperRulesRes  {
  ...
  private OperRulesResResults results = null;
   ...
   **/
  @ApiModelProperty(value = "")
  public OperRulesResResults getResults() {
    return results;
  }
  public void setResults(OperRulesResResults results) {
  ...
  public boolean equals(Object o) {
    ...
    OperRulesRes operRulesRes = (OperRulesRes) o;
    return (this.status == null ? operRulesRes.status == null : this.status.equals(operRulesRes.status)) &&
        (this.message == null ? operRulesRes.message == null : this.message.equals(operRulesRes.message)) &&
        (this.results == null ? operRulesRes.results == null : this.results.equals(operRulesRes.results));
  }
