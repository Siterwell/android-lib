...
public class PlaceItem  {
   ...
   * Place id
   **/
  @ApiModelProperty(required = true, value = "Place id")
  public String getId() {
    return id;
  }
   ...
   **/
  @ApiModelProperty(required = true, value = "Place description name")
   ...
   * Place icon type
   **/
  @ApiModelProperty(value = "Place icon type")
   ...
   * UI display ordering
   **/
  @ApiModelProperty(value = "UI display ordering")
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? placeItem.id == null : this.id.equals(placeItem.id)) &&
        (this.name == null ? placeItem.name == null : this.name.equals(placeItem.name)) &&
        (this.iconType == null ? placeItem.iconType == null : this.iconType.equals(placeItem.iconType)) &&
        (this.order == null ? placeItem.order == null : this.order.equals(placeItem.order));
  }
