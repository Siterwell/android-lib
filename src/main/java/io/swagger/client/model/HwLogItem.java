...
public class HwLogItem  {
  ...
  /**
   * file binary date (encode with base64)
   **/
  @ApiModelProperty(value = "file binary date (encode with base64)")
  ...
  public boolean equals(Object o) {
    ...
    HwLogItem hwLogItem = (HwLogItem) o;
    return (this.name == null ? hwLogItem.name == null : this.name.equals(hwLogItem.name)) &&
        (this.content == null ? hwLogItem.content == null : this.content.equals(hwLogItem.content));
  }
