...
public class ActionItem  {
  ...
  public boolean equals(Object o) {
    ...
    return (this.devId == null ? actionItem.devId == null : this.devId.equals(actionItem.devId)) &&
        (this.name == null ? actionItem.name == null : this.name.equals(actionItem.name)) &&
        (this.value == null ? actionItem.value == null : this.value.equals(actionItem.value));
  }
