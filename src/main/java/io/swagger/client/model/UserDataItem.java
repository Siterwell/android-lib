...
public class UserDataItem  {
   ...
   * User data name
   **/
  @ApiModelProperty(required = true, value = "User data name")
   ...
   * User data value
   **/
  @ApiModelProperty(required = true, value = "User data value")
  ...
  public boolean equals(Object o) {
    ...
    UserDataItem userDataItem = (UserDataItem) o;
    return (this.name == null ? userDataItem.name == null : this.name.equals(userDataItem.name)) &&
        (this.value == null ? userDataItem.value == null : this.value.equals(userDataItem.value));
  }
