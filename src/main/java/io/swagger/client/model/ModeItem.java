...
public class ModeItem  {
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? modeItem.id == null : this.id.equals(modeItem.id)) &&
        (this.value == null ? modeItem.value == null : this.value.equals(modeItem.value));
  }
