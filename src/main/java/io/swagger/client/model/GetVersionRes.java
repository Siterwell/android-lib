...
import io.swagger.client.model.GetVersionResResults;
...
public class GetVersionRes  {
  ...
  private GetVersionResResults results = null;
   ...
   **/
  @ApiModelProperty(value = "")
  public GetVersionResResults getResults() {
    return results;
  }
  public void setResults(GetVersionResResults results) {
  ...
  public boolean equals(Object o) {
    ...
    GetVersionRes getVersionRes = (GetVersionRes) o;
    return (this.status == null ? getVersionRes.status == null : this.status.equals(getVersionRes.status)) &&
        (this.message == null ? getVersionRes.message == null : this.message.equals(getVersionRes.message)) &&
        (this.results == null ? getVersionRes.results == null : this.results.equals(getVersionRes.results));
  }
