...
import io.swagger.client.model.ActionItem;
import io.swagger.client.model.ConditionItem;
import java.util.*;
...
public class RuleItem  {
  ...
  private List<ActionItem> actions = null;

  /**
   * rule id
   **/
  @ApiModelProperty(required = true, value = "rule id")
   ...
   * rule mode id
   **/
  @ApiModelProperty(required = true, value = "rule mode id")
  ...
  public boolean equals(Object o) {
    ...
    return (this.ruleId == null ? ruleItem.ruleId == null : this.ruleId.equals(ruleItem.ruleId)) &&
        (this.name == null ? ruleItem.name == null : this.name.equals(ruleItem.name)) &&
        (this.desc == null ? ruleItem.desc == null : this.desc.equals(ruleItem.desc)) &&
        (this.modes == null ? ruleItem.modes == null : this.modes.equals(ruleItem.modes)) &&
        (this.conditions == null ? ruleItem.conditions == null : this.conditions.equals(ruleItem.conditions)) &&
        (this.actions == null ? ruleItem.actions == null : this.actions.equals(ruleItem.actions));
  }
