...
import io.swagger.client.model.GetRulesResResults;
...
public class GetRulesRes  {
  ...
  private GetRulesResResults results = null;
   ...
   **/
  @ApiModelProperty(value = "")
  public GetRulesResResults getResults() {
    return results;
  }
  public void setResults(GetRulesResResults results) {
  ...
  public boolean equals(Object o) {
    ...
    GetRulesRes getRulesRes = (GetRulesRes) o;
    return (this.status == null ? getRulesRes.status == null : this.status.equals(getRulesRes.status)) &&
        (this.message == null ? getRulesRes.message == null : this.message.equals(getRulesRes.message)) &&
        (this.results == null ? getRulesRes.results == null : this.results.equals(getRulesRes.results));
  }
