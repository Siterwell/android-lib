...
import io.swagger.client.model.ReportItem;
import java.util.*;
...
public class ReportRes  {
  ...
  private List<ReportItem> results = null;
   ...
   **/
  @ApiModelProperty(value = "")
  public List<ReportItem> getResults() {
    return results;
  }
  public void setResults(List<ReportItem> results) {
  ...
  public boolean equals(Object o) {
    ...
    return (this.status == null ? reportRes.status == null : this.status.equals(reportRes.status)) &&
        (this.message == null ? reportRes.message == null : this.message.equals(reportRes.message)) &&
        (this.results == null ? reportRes.results == null : this.results.equals(reportRes.results));
  }
