...
import io.swagger.client.model.DeviceItemRes;
import java.util.*;
...
public class GetDevicesResResults  {
  
  @SerializedName("devices")
  private List<DeviceItemRes> devices = null;

  /**
   **/
  @ApiModelProperty(value = "")
  public List<DeviceItemRes> getDevices() {
    return devices;
  }
  public void setDevices(List<DeviceItemRes> devices) {
  ...
  public boolean equals(Object o) {
    ...
    GetDevicesResResults getDevicesResResults = (GetDevicesResResults) o;
    return (this.devices == null ? getDevicesResResults.devices == null : this.devices.equals(getDevicesResResults.devices));
  }
  ...
  public String toString()  {
    ...
    sb.append("class GetDevicesResResults {\n");
