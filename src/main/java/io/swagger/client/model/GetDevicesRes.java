...
import io.swagger.client.model.GetDevicesResResults;
...
public class GetDevicesRes  {
  ...
  private GetDevicesResResults results = null;
   ...
   **/
  @ApiModelProperty(value = "")
  public GetDevicesResResults getResults() {
    return results;
  }
  public void setResults(GetDevicesResResults results) {
  ...
  public boolean equals(Object o) {
    ...
    GetDevicesRes getDevicesRes = (GetDevicesRes) o;
    return (this.status == null ? getDevicesRes.status == null : this.status.equals(getDevicesRes.status)) &&
        (this.message == null ? getDevicesRes.message == null : this.message.equals(getDevicesRes.message)) &&
        (this.results == null ? getDevicesRes.results == null : this.results.equals(getDevicesRes.results));
  }
