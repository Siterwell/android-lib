...
public class PropertyItem  {
  ...
  public boolean equals(Object o) {
    ...
    return (this.name == null ? propertyItem.name == null : this.name.equals(propertyItem.name)) &&
        (this.value == null ? propertyItem.value == null : this.value.equals(propertyItem.value));
  }
