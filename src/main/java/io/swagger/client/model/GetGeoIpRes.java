...
import io.swagger.client.model.GetGeoIpResResults;
...
public class GetGeoIpRes  {
  ...
  private GetGeoIpResResults results = null;
   ...
   **/
  @ApiModelProperty(value = "")
  public GetGeoIpResResults getResults() {
    return results;
  }
  public void setResults(GetGeoIpResResults results) {
  ...
  public boolean equals(Object o) {
    ...
    GetGeoIpRes getGeoIpRes = (GetGeoIpRes) o;
    return (this.status == null ? getGeoIpRes.status == null : this.status.equals(getGeoIpRes.status)) &&
        (this.message == null ? getGeoIpRes.message == null : this.message.equals(getGeoIpRes.message)) &&
        (this.results == null ? getGeoIpRes.results == null : this.results.equals(getGeoIpRes.results));
  }
