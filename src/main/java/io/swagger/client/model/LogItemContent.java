...
import io.swagger.client.model.ParmItem;
import java.util.*;
...
public class LogItemContent  {
  
  @SerializedName("type")
  private String type = null;
  @SerializedName("parms")
  private List<ParmItem> parms = null;
   ...
   **/
  @ApiModelProperty(value = "")
  public List<ParmItem> getParms() {
    return parms;
  }
  public void setParms(List<ParmItem> parms) {
    this.parms = parms;
  }
  ...
  public boolean equals(Object o) {
    ...
    LogItemContent logItemContent = (LogItemContent) o;
    return (this.type == null ? logItemContent.type == null : this.type.equals(logItemContent.type)) &&
        (this.parms == null ? logItemContent.parms == null : this.parms.equals(logItemContent.parms));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.parms == null ? 0: this.parms.hashCode());
    return result;
  }
  ...
  public String toString()  {
    ...
    sb.append("class LogItemContent {\n");
    
    sb.append("  type: ").append(type).append("\n");
    sb.append("  parms: ").append(parms).append("\n");
    sb.append("}\n");
    return sb.toString();
  }
}
