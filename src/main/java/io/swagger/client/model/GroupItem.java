...
public class GroupItem  {
   ...
   * Group value
   **/
  @ApiModelProperty(required = true, value = "Group value")
  ...
  public boolean equals(Object o) {
    ...
    return (this.id == null ? groupItem.id == null : this.id.equals(groupItem.id)) &&
        (this.value == null ? groupItem.value == null : this.value.equals(groupItem.value)) &&
        (this.order == null ? groupItem.order == null : this.order.equals(groupItem.order));
  }
