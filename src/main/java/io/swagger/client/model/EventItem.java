...
public class EventItem  {
  ...
  public boolean equals(Object o) {
    ...
    return (this.purpose == null ? eventItem.purpose == null : this.purpose.equals(eventItem.purpose)) &&
        (this.group == null ? eventItem.group == null : this.group.equals(eventItem.group)) &&
        (this.time == null ? eventItem.time == null : this.time.equals(eventItem.time)) &&
        (this.content == null ? eventItem.content == null : this.content.equals(eventItem.content));
  }
