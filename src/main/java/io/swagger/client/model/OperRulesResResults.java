...
import io.swagger.client.model.OperRuleItemRes;
import java.util.*;
...
public class OperRulesResResults  {
  
  @SerializedName("rules")
  private List<OperRuleItemRes> rules = null;

  /**
   **/
  @ApiModelProperty(value = "")
  public List<OperRuleItemRes> getRules() {
    return rules;
  }
  public void setRules(List<OperRuleItemRes> rules) {
    this.rules = rules;
  }
  ...
  public boolean equals(Object o) {
    ...
    OperRulesResResults operRulesResResults = (OperRulesResResults) o;
    return (this.rules == null ? operRulesResResults.rules == null : this.rules.equals(operRulesResResults.rules));
  }
  ...
  public String toString()  {
    ...
    sb.append("class OperRulesResResults {\n");
