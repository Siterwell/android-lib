...
public class SuccessRes  {
  ...
  public boolean equals(Object o) {
    ...
    SuccessRes successRes = (SuccessRes) o;
    return (this.status == null ? successRes.status == null : this.status.equals(successRes.status)) &&
        (this.message == null ? successRes.message == null : this.message.equals(successRes.message)) &&
        (this.results == null ? successRes.results == null : this.results.equals(successRes.results));
  }
