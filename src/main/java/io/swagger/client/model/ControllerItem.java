...
public class ControllerItem  {
  ...
  public boolean equals(Object o) {
    ...
    ControllerItem controllerItem = (ControllerItem) o;
    return (this.controllerId == null ? controllerItem.controllerId == null : this.controllerId.equals(controllerItem.controllerId)) &&
        (this.name == null ? controllerItem.name == null : this.name.equals(controllerItem.name)) &&
        (this.active == null ? controllerItem.active == null : this.active.equals(controllerItem.active)) &&
        (this.caps == null ? controllerItem.caps == null : this.caps.equals(controllerItem.caps)) &&
        (this.modes == null ? controllerItem.modes == null : this.modes.equals(controllerItem.modes)) &&
        (this.groups == null ? controllerItem.groups == null : this.groups.equals(controllerItem.groups)) &&
        (this.places == null ? controllerItem.places == null : this.places.equals(controllerItem.places)) &&
        (this.props == null ? controllerItem.props == null : this.props.equals(controllerItem.props)) &&
        (this.devices == null ? controllerItem.devices == null : this.devices.equals(controllerItem.devices));
  }
  ...
  public String toString()  {
    ...
    sb.append("class ControllerItem {\n");
