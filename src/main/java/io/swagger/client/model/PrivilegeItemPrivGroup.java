...
public class PrivilegeItemPrivGroup  {
   ...
   * privilege owner
   **/
  @ApiModelProperty(required = true, value = "privilege owner")
   ...
   * privilege name
   **/
  @ApiModelProperty(required = true, value = "privilege name")
   ...
   * privilege status
   **/
  @ApiModelProperty(value = "privilege status")
   ...
   * expired time
   **/
  @ApiModelProperty(value = "expired time")
  ...
  public boolean equals(Object o) {
    ...
    PrivilegeItemPrivGroup privilegeItemPrivGroup = (PrivilegeItemPrivGroup) o;
    return (this.email == null ? privilegeItemPrivGroup.email == null : this.email.equals(privilegeItemPrivGroup.email)) &&
        (this.priv == null ? privilegeItemPrivGroup.priv == null : this.priv.equals(privilegeItemPrivGroup.priv)) &&
        (this.status == null ? privilegeItemPrivGroup.status == null : this.status.equals(privilegeItemPrivGroup.status)) &&
        (this.expiredTime == null ? privilegeItemPrivGroup.expiredTime == null : this.expiredTime.equals(privilegeItemPrivGroup.expiredTime));
  }
  ...
  public int hashCode() {
    ...
    result = 31 * result + (this.priv == null ? 0: this.priv.hashCode());
  ...
  public String toString()  {
    ...
    sb.append("class PrivilegeItemPrivGroup {\n");
