...
public class StatusItem  {
  ...
  public boolean equals(Object o) {
    ...
    return (this.name == null ? statusItem.name == null : this.name.equals(statusItem.name)) &&
        (this.value == null ? statusItem.value == null : this.value.equals(statusItem.value)) &&
        (this.message == null ? statusItem.message == null : this.message.equals(statusItem.message));
  }
