...
public class MessageRes  {
  ...
  public boolean equals(Object o) {
    ...
    MessageRes messageRes = (MessageRes) o;
    return (this.status == null ? messageRes.status == null : this.status.equals(messageRes.status)) &&
        (this.message == null ? messageRes.message == null : this.message.equals(messageRes.message));
  }
