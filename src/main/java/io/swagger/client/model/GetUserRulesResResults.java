...
import io.swagger.client.model.GetUsersRulesItem;
import java.util.*;
...
public class GetUserRulesResResults  {
  
  @SerializedName("controllers")
  private List<GetUsersRulesItem> controllers = null;

  /**
   **/
  @ApiModelProperty(value = "")
  public List<GetUsersRulesItem> getControllers() {
    return controllers;
  }
  public void setControllers(List<GetUsersRulesItem> controllers) {
  ...
  public boolean equals(Object o) {
    ...
    GetUserRulesResResults getUserRulesResResults = (GetUserRulesResResults) o;
    return (this.controllers == null ? getUserRulesResResults.controllers == null : this.controllers.equals(getUserRulesResResults.controllers));
  }
  ...
  public String toString()  {
    ...
    sb.append("class GetUserRulesResResults {\n");
