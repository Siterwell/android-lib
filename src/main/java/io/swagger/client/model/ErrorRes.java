...
public class ErrorRes  {
  ...
  public boolean equals(Object o) {
    ...
    return (this.status == null ? errorRes.status == null : this.status.equals(errorRes.status)) &&
        (this.message == null ? errorRes.message == null : this.message.equals(errorRes.message));
  }
