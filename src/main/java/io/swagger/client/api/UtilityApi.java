...
import io.swagger.client.model.GetGeoIpRes;
import io.swagger.client.model.GeoItem;
import io.swagger.client.model.SuccessRes;
import io.swagger.client.model.GetVersionRes;
import io.swagger.client.model.PushNotificationItem;
...
public class UtilityApi {
  ...
  * 
   * @param controllerId Update controller&#39;s location if its ID was assgined.
   * @return GetGeoIpRes
  */
  public GetGeoIpRes apiGeoIpGet (String controllerId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = null;
  

  // create path and map variables
  String path = "/api/1/geoIp/".replaceAll("\\{format\\}","json");
  ...
  "application/json"
      ...
      try {
        ...
        if(localVarResponse != null){
           return (GetGeoIpRes) ApiInvoker.deserialize(localVarResponse, "", GetGeoIpRes.class);
        } else {
           return null;
        }
   ...
   * @param controllerId Update controller&#39;s location if its ID was assgined.
  */
  public void apiGeoIpGet (String controllerId, final Response.Listener<GetGeoIpRes> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
      ...
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((GetGeoIpRes) ApiInvoker.deserialize(localVarResponse,  "", GetGeoIpRes.class));
  ...
  * 
   ...
   * @return SuccessRes
  */
  public SuccessRes apiGeoIpPost (GeoItem body) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = body;
  
      // verify the required parameter 'body' is set
      if (body == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'body' when calling apiGeoIpPost",
      new ApiException(400, "Missing the required parameter 'body' when calling apiGeoIpPost"));
      }
   ...
   * @param body 
  */
  public void apiGeoIpPost (GeoItem body, final Response.Listener<SuccessRes> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = body;
  ...
  */
  public GetVersionRes apiGetVersion () throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = null;
  

  // create path and map variables
  String path = "/api/1/version/".replaceAll("\\{format\\}","json");
  ...
  "application/json"
      ...
      try {
        String localVarResponse = apiInvoker.invokeAPI (basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames);
        if(localVarResponse != null){
           return (GetVersionRes) ApiInvoker.deserialize(localVarResponse, "", GetVersionRes.class);
        } else {
           return null;
        }
      } catch (ApiException ex) {
  ...
  */
  public void apiGetVersion (final Response.Listener<GetVersionRes> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
    ...
    try {
      apiInvoker.invokeAPI(basePath, path, "GET", queryParams, postBody, headerParams, formParams, contentType, authNames,
        new Response.Listener<String>() {
          ...
          public void onResponse(String localVarResponse) {
            try {
              responseListener.onResponse((GetVersionRes) ApiInvoker.deserialize(localVarResponse,  "", GetVersionRes.class));
            } catch (ApiException exception) {
               errorListener.onErrorResponse(new VolleyError(exception));
            }
          }
  ...
  * 
   ...
   * @return SuccessRes
  */
  public SuccessRes apiPushNotificationDelete (String senderId) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = null;
  
      // verify the required parameter 'senderId' is set
      if (senderId == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'senderId' when calling apiPushNotificationDelete",
      new ApiException(400, "Missing the required parameter 'senderId' when calling apiPushNotificationDelete"));
      }
  

  // create path and map variables
  String path = "/api/1/pushNotification/".replaceAll("\\{format\\}","json");
  ...
  List<Pair> queryParams = new ArrayList<Pair>();
      ...
      Map<String, String> formParams = new HashMap<String, String>();
          ...
          queryParams.addAll(ApiInvoker.parameterToPairs("", "senderId", senderId));
   ...
   * @param senderId 
  */
  public void apiPushNotificationDelete (String senderId, final Response.Listener<SuccessRes> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = null;
  ...
  * 
   ...
   * @return SuccessRes
  */
  public SuccessRes apiPushNotificationPost (PushNotificationItem body) throws TimeoutException, ExecutionException, InterruptedException, ApiException {
     Object postBody = body;
  
      // verify the required parameter 'body' is set
      if (body == null) {
      VolleyError error = new VolleyError("Missing the required parameter 'body' when calling apiPushNotificationPost",
      new ApiException(400, "Missing the required parameter 'body' when calling apiPushNotificationPost"));
      }
   ...
   * @param body 
  */
  public void apiPushNotificationPost (PushNotificationItem body, final Response.Listener<SuccessRes> responseListener, final Response.ErrorListener errorListener) {
    Object postBody = body;
